...
try:
    ...
    print("❌ pydicom is required. Install with: pip install pydicom pandas numpy")
    sys.exit(1)
...
try:
    ...
    if CREATE_MP4_FOR_MULTIFRAME:
        print("❌ OpenCV is required for MP4 creation. Install with: pip install opencv-python")
        sys.exit(1)
